...
namespace HealthRisksInRestaurantsPrediction_ConsoleApp
{
    ...
    {
        /// <summary>
        /// model input class for HealthRisksInRestaurantsPrediction.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("HealthRisksInRestaurantsPrediction.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("risk_category");
            if (labelColumn == null)
            {
                throw new Exception("risk_category column not found. Make sure the name searched for matches the name in the schema.");
            }
